...
# 多项式回归方程各系数
a = poly_reg[2].coef_[4]
b = poly_reg[2].coef_[3]
c = poly_reg[2].coef_[2]
d = poly_reg[2].coef_[1]
e = poly_reg[2].intercept_

# 计算残差
r = CR.CommuteRe(data, y_true=y, y_predict=y_predict)

print("多项式回归模型， y = {}x**4 + {}x**3 + {}x**2 + {}x + {}.".format(a, b, c, d, e))
...
plt.savefig(f'4次多项式回归散点图.png', dpi=500)
plt.show()
